...
/* Created on:     18.11.2018 17:44:58                          */
/*==============================================================*/
...
alter table User_has_theme
   drop constraint FK_USER_HAS_THEME;
...
alter table user_has_resourses
   drop constraint FK_USER_HAS_RESOURSES;
...
(
   ...
   Lection_name         VARCHAR2(150)        not null,
   user_nickname        VARCHAR2(25)         not null,
   "Date"               DATE                 not null,
   constraint PK_USER_HAS_THEME primary key (user_theme_id)
);

/*==============================================================*/
/* Index: user_use_theme_FK                                     */
/*==============================================================*/
create index user_use_theme_FK on User_has_theme (
   user_nickname ASC
);
...
/*==============================================================*/
/* Index: user_use_resourse_FK                                  */
/*==============================================================*/
create index user_use_resourse_FK on user_has_resourses (
   user_nickname ASC
);
...
alter table User_has_theme
   add constraint FK_USER_HAS_THEME foreign key (user_nickname)
      references "User" (nickname);
...
alter table user_has_resourses
   add constraint FK_USER_HAS_RESOURSES foreign key (user_nickname)
      references "User" (nickname);
...
alter table User_has_theme
   add constraint UhT_user_nick_check CHECK (REGEXP_LIKE(user_nickname,'^[A-Za-z].*'));
alter table User_has_theme
   add constraint User_has_theme_unique UNIQUE (Author_nickname, user_nickname);
   
alter table User_has_resourses
   add constraint UhR_author_check CHECK (REGEXP_LIKE(Author_nickname,'^[A-Za-z].*'));
alter table User_has_resourses
   add constraint UhR_user_nick_check CHECK (REGEXP_LIKE(user_nickname,'^[A-Za-z].*'));
alter table User_has_resourses
   add constraint User_has_resourses_unique UNIQUE (Author_nickname, user_nickname);
