...
('vadya', 'vadya9', 'vadimka', 'Vadym', 'Applied mathematics', 4);
...
values (1, 'vadimka','Math logarithm', TO_DATE('2005/05/03', 'yyyy/mm/dd'));
...
values (1, 'vadimka','www.pidruchniki.ua', TO_DATE('2005/05/03', 'yyyy/mm/dd'));
